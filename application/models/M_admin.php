...
class M_admin extends CI_Model
{
    ...
    function select_select_where_limit_orderBy($select, $table, $where, $limit, $orderby)
    {
        return $this->db->select($select)
        ->from($table)
        ->where($where)
    ...
    function select_select_join_3table_type_orderBy($select, $table1, $table2, $on2, $type2, $table3, $on3, $type3, $orderBy)
    {
        return $this->db->select($select)
        ->from($table1)
        ->join($table2, $on2, $type2)
